...
void count_designation(Employee ** ptr ,int index){
    ...
    cout<<"Total Mnagers : "<<mcount<<endl;
...
int main() {
    ...
    while (choice!=Menu::EXIT) {
        ...
        cout << "0: EXIT"<<endl;
        cout << "1: ACCEPT_EMPLOYEE"<<endl;
        cout << "2: DISPLAY_COUNT_DESIGNATION"<<endl;
        cout << "3: DISPLAY_MANAGERS"<<endl;
        cout << "4: DISPLAY_SALESMAN"<<endl;
        cout << "5: DISPLAY_SALESMANAGERS"<<endl;
        cin >> choice;
        ...
        case Menu::ACCEPT_EMPLOYEE: {
            ...
            while (true) {
                cout << "Enter your choice:"<<endl;
                cout << "0: EXIT"<<endl;
                cout << "1: ACCEPT_MANAGER"<<endl;
                cout << "2: ACCEPT_SALESMAN"<<endl;
                cout << "3: ACCEPT_SALESMANAGER"<<endl;
                cin >> Choice;
